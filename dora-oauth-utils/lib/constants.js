...
var output = {
    ...
    defaults: {
        /* oauth 客户端服务器的接口地址配置 */
        // oauth 客户端服务器的接口地址前缀
        rootPrefix: '/dora_oauth/2/wechat',
        ...
        storeCredentialsUri: '/accounts/oauth/2/wechat',
        credentialLoginUri: '/accounts/users/login/credentials',
        assetsUri: '/assets',

        /* 微信 oauth 登录发起地址 */
        authorizeURLBase: 'https://open.weixin.qq.com/connect/oauth2/authorize',
        authorizeURLBaseForWebsite: 'https://open.weixin.qq.com/connect/qrconnect'
    },
